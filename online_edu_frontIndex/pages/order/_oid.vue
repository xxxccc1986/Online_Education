  ...
  <div class="Page Confirm">
    ...
    <form name="flowForm" id="flowForm" method="post" action="">
      <table class="GoodList">
        ...
        <tr class="good">
          <td class="name First">
            <a target="_blank" :href="'http://116.205.178.255:80/course/'+order.courseId">
              <img :src="order.courseCover"></a>
            <div class="goodInfo">
              <input type="hidden" class="ids ids_14502" value="14502">
              <a target="_blank" :href="'http://116.205.178.255:80/course/'+ order.courseId">{{order.courseTitle}}</a>
            </div>
          </td>
          <td class="price">
...
export default {
    ...
    methods: {
        ...
        //拉起二维码支付页面
        toPay(){
          order.createOrderCode(this.orderNo)
            .then(response => {
